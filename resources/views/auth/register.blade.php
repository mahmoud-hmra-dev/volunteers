    ...
    <div class="form-v10-content">
        <form class="form-detail" method="post" id="myform">
            ...
            <div class="form-left">
                ...
                <div class="form-row">
                    <input type="text" name="email" id="your_email" class="input-text" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}" placeholder="Your Email" value="{{ old('email') }}">
                </div>
                <div class="form-row">

                    <input id="password" type="password" class="input-text" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Your passowrd">
                ...
                <div class="form-row">
                    ...
                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" class="input-text" required autocomplete="new-password" placeholder="password-confirm">
                ...
                <div class="form-group form-row">
                    ...
                    @foreach(App\User::NOTIFICATIONS_FREQUENCY_RADIO as $key => $label)
                        <div class="form-check ">
                            <label class="radio-container m-r-45" for="notifications_frequency_{{ $key }}">
                            <input  type="radio" id="notifications_frequency_{{ $key }}" name="notifications_frequency" value="{{ $key }}" {{ old('notifications_frequency', 'once') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-right">
             ...
             <div class="form-row">
                ...
                <div class="form-row-last">
                    <input type="submit" name="register" class="register" value="Volunteer Register">
...
<link href="{{ URL::asset('css/montserrat-font.css') }}" rel='stylesheet'>
<link href="{{ URL::asset('css/select2.css') }}" rel='stylesheet'>
<link href="{{ URL::asset('fonts/material-design-iconic-font/css/material-design-iconic-font.min.css') }}" rel='stylesheet'>
